    ...
    items: [
      {
        ...
        slug: 'apim-',
        description:
          'Azure API Management is a solution for publishing, managing, securing, and analyzing APIs in a secure and scalable environment. It provides a unified way to manage and protect your APIs, both on-premises and cloud-based.',
        length: '1-50',
      ...
      },
      {
        ...
        slug: 'id-',
        description:
          'Azure Managed Identity eliminates the need for developers to manage credentials. It provides an identity for applications to use when connecting to resources, so they can focus on their work instead of worrying about managing secrets or credentials.',
        length: '3-128',
        category: Categories.GENERAL,
        learnUrl:
      ...
      },
      {
        ...
        slug: 'mg-',
        description:
          'Azure Management Groups offer a level of scope above subscriptions. They provide a way to efficiently manage access, policies, and compliance across an enterprise through inheritance of control planes.',
        length: '',
        category: Categories.GENERAL,
        learnUrl: '',
        terraformUrl: '',
      ...
      },
      {
        ...
        slug: 'policy-',
        description:
          'Azure Policy Definition is a declaration of a desired state in Azure. It is used to enforce organizational standards and to assess compliance at-scale. With it, you can ensure services are properly and consistently configured.',
        length: '1-128 display name1-64 resource name',
        category: Categories.GENERAL,
        learnUrl: '',
        terraformUrl: '',
        restrictions:
          "Display name can contain any characters. Resource name can't use:<>*%&:\\?. +/ or control characters. Can't end with period or space.",
      ...
      },
      {
        ...
        slug: 'rg-',
        description:
          "Azure Resource Group is a container that holds related resources for an Azure solution. It's a logical group for resources that are deployed within an Azure subscription.",
        length: '1-90',
        category: Categories.GENERAL,
        learnUrl: '',
        terraformUrl: '',
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        slug: 'asg-',
        description:
          'Application Security Groups in Azure enable you to configure network security as a natural extension of an application’s structure.',
        length: '1-80',
        category: Categories.NETWORKING,
        learnUrl: '',
        terraformUrl: '',
      ...
      },
      {
        ...
        slug: 'bas-',
        description:
          'Azure Bastion is a fully managed network security service that provides secure and seamless RDP and SSH access to your virtual machines.',
        length: '1-80',
        category: Categories.NETWORKING,
        learnUrl: '',
        terraformUrl: '',
      ...
      },
      {
        ...
        slug: 'cdnp-',
        description:
          'Azure CDN profiles allow you to manage delivery of content with high bandwidth and low latency.',
        length: '1-260',
        category: Categories.NETWORKING,
        learnUrl: '',
        terraformUrl: '',
      ...
      },
      {
        ...
        slug: 'cdne-',
        description:
          'CDN Endpoints in Azure are the points of presence (PoP) for your content to be delivered faster to your users.',
        length: '1-50',
        category: Categories.NETWORKING,
        learnUrl: '',
        terraformUrl: '',
      ...
      },
      {
        ...
        slug: 'con-',
        description:
          'Azure Connections are the links created between two virtual networks, allowing them to work as a single, logical network.',
        length: '1-80',
        category: Categories.NETWORKING,
        learnUrl: '',
        terraformUrl: '',
      ...
      },
      {
        ...
        slug: 'dnsz-',
        description:
          "Azure DNS Zone is a service that hosts your domain's DNS records and provides name resolution for your domain.",
        length:
      ...
      },
      {
        ...
        slug: 'pdnsz-',
        description:
          'Azure Private DNS Zone is a service that provides custom domain name resolution inside a virtual network.',
        length:
          '1-63 characters2 to 34 labelsEach label is a set of characters separated by a period. For example, contoso.com has 2 labels.',
        category: Categories.NETWORKING,
        learnUrl: '',
      ...
      },
      {
        ...
        slug: 'afwp-',
        description:
          'Azure Firewall Policy is a global resource that enables you to manage and centrally control your firewalls using rules and concepts such as threat intelligence and service tags.',
        length: '1-80',
        category: Categories.NETWORKING,
        learnUrl: '',
        terraformUrl: '',
    ...
    items: [
      {
        ...
        restrictions:
          "Alphanumeric, hyphens and Unicode characters that can be mapped to PunycodeCan't start or end with hyphen.",
      ...
      },
      {
        ...
        restrictions:
          "Can't use spaces, control characters, or these characters: ~ ! @ # $ % ^ & * ( ) = + _ [ ] { }  | ; : . ' \". Can't start with underscore. Can not end with period or hyphen.",
        resource: 'Microsoft.Compute',
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        restrictions:
          "Can't use spaces, control characters, or these characters: ~ ! @ # $ % ^ & * ( ) = + _ [ ] { }  | ; : . ' \". Windows VMs can't include period or end with hyphen. Linux VMs can't end with period or hyphen.",
        resource: 'Microsoft.Compute',
      ...
      },
      {
        ...
        restrictions:
          "Can't use spaces, control characters, or these characters: ~ ! @ # $ % ^ & * ( ) = + _ [ ] { }  | ; : . ' \". Can't start with underscore. Can't end with period or hyphen.",
        resource: 'Microsoft.Compute',
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        restrictions:
          "Lowercase letters, numbers, and hyphens. Can't start or end with hyphen. Consecutive hyphens aren't allowed.",
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        restrictions:
          "Can't use:<>%&:/? or control charactersCan't end with period or space.",
        resource: 'Microsoft.Sql',
      ...
      },
      {
        ...
        restrictions:
          "Lowercase letters, hyphens, and numbers. Start and end with letter or number. Can't contain -ondemand",
      ...
      },
      {
        ...
        restrictions:
          "Can't contain <>%&:/?@- or control characters. Can't end with . or space. Can't contain reserved word.",
        resource: 'Microsoft.Synapse',
      ...
      },
      {
        ...
        restrictions:
          "Letters and numbers. Start with letter. End with letter or number. Can't contain reserved word.",
        resource: 'Microsoft.Synapse',
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        restrictions:
          "Can't use:<>%&:?+/ or control charactersCan't end with a space.",
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        restrictions:
          "Alphanumerics and hyphens. Can't start with hyphen. Can't use consecutive hyphens.",
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        slug: 'migr-',
        description:
          'Azure Migrate provides a centralized hub to discover, assess, and migrate to Azure on-premises servers, infrastructure, applications, and data. It provides tools to help you plan, track, and conduct migrations.',
        length: '2-57',
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        restrictions:
          "Can't use:%&?/ or control characters Can't end with space or period.",
