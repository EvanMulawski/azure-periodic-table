    ...
    items: [
      {
        ...
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/expressroute/expressroute-introduction",
      ...
      },
      {
        ...
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/load-balancer/load-balancer-overview",
      ...
      },
      {
        ...
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/virtual-network/nat-gateway/nat-overview",
      ...
      },
      {
        ...
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-network-interface",
  ...
  },
  {
    items: [
      ...
      },
      {
        name: "private link",
        slug: "pl-",
        description: "Azure Private Link provides private connectivity from a virtual network to Azure platform as a service (PaaS), customer-owned, or Microsoft partner services.",
        length: "2-64",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/private-link/private-link-overview",
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/private_link_service",
        restrictions: "Alphanumerics, underscores, periods, and hyphens. Start with alphanumeric.  End alphanumeric or underscore.",
        resource: "Microsoft.Network",
      ...
      },
      {
        ...
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/virtual-network/ip-services/overview-ip-address-public",
      ...
      },
      {
        ...
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/service_endpoint_policy",
        restrictions: "Alphanumerics, underscores, periods, and hyphens. Start with alphanumeric.  End alphanumeric or underscore.",
        resource: "Microsoft.Network",
      ...
      },
      {
        ...
        length: "1-63",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/traffic-manager/traffic-manager-overview",
      ...
      },
      {
        ...
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/virtual-network/tutorial-create-route-table-portal",
    ...
    items: [
      {
        ...
        length: "2-64",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/virtual-network/virtual-networks-overview",
      ...
      },
      {
        ...
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-manage-subnet",
      ...
      },
      {
        ...
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-manage-peering",
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/virtual_network_peering",
        restrictions: "Alphanumerics, underscores, periods, and hyphens. Start with alphanumeric.  End alphanumeric or underscore.",
        resource: "Microsoft.Network",
      ...
      },
      {
        ...
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/virtual-wan/virtual-wan-about",
      ...
      },
      {
        name: "vpn connection",
        slug: "vcn-",
        description: "A VPN Connection in Azure is used to connect a virtual network gateway and a local network gateway, which is typically your on-premises network. It provides a secure, encrypted connection over the internet between your Azure virtual network and your on-premise network.",
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/vpn-gateway/vpn-gateway-howto-site-to-site-resource-manager-portal",
      ...
      },
      {
        ...
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/web-application-firewall/afds/afds-overview",
      ...
      },
      {
        ...
        length: "1-80",
        category: Categories.NETWORKING,
        learnUrl: "https://docs.microsoft.com/en-us/azure/web-application-firewall/afds/waf-front-door-create-portal",
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/web_application_firewall_policy",
        restrictions: "Alphanumerics, underscores, periods, and hyphens. Start with alphanumeric.  End alphanumeric or underscore.",
        resource: "Microsoft.Network",
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        length: "1-40",
        category: Categories.COMPUTEANDWEB,
        learnUrl: "https://docs.microsoft.com/en-us/azure/azure-arc/servers/overview",
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/azure_arc_enabled_server",
        restrictions: "Alphanumeric, hyphens and Unicode characters that can be mapped to Punycode",
        resource: "Microsoft.Web",
        entity: "serverfarms",
        scope: "resource group",
      ...
      },
      {
        ...
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/azure_arc_enabled_kubernetes_cluster",
      ...
      },
      {
        name: "cloud service",
        slug: "cld-",
        description: "Azure Cloud Services is an example of a platform as a service (PaaS). It lets developers concentrate on their application logic, while Azure takes care of the infrastructure needed to run and scale the apps.",
        length: "1-15",
        category: Categories.COMPUTEANDWEB,
      ...
      },
      {
        ...
        length: "1-80",
        category: Categories.COMPUTEANDWEB,
        learnUrl: "https://docs.microsoft.com/en-us/azure/virtual-machines/disk-encryption-set-overview",
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        length: "6-50",
        category: Categories.COMPUTEANDWEB,
        learnUrl: "https://docs.microsoft.com/en-us/azure/notification-hubs/notification-hubs-push-notification-overview",
      ...
      },
      {
        ...
        slug: "stvm",
        description: "Azure Storage Accounts offer a unique namespace to store and access your Azure Storage data objects.",
        length: "3-24",
        category: Categories.COMPUTEANDWEB,
      ...
      },
      {
        name: "web app",
        slug: "app-",
        description: "Azure Web Apps is a fully managed platform that enables you to build, deploy, and scale enterprise-grade web applications with ease.",
        length: "2-60",
        category: Categories.COMPUTEANDWEB,
    ...
    items: [
      {
        ...
        learnUrl: "https://docs.microsoft.com/en-us/azure/cosmos-db/introduction",
      ...
      },
      {
        ...
        length: "1-63",
        category: Categories.DATABASES,
        learnUrl: "https://docs.microsoft.com/en-us/azure/azure-cache-for-redis/cache-overview",
      ...
      },
      {
        ...
        slug: "synw",
        description: "Azure Synapse Analytics Workspaces provide a single point of control for security, monitoring, and metadata management. Each workspace is tied to an Azure Data Lake Store, allowing to manage big data easily.",
        length: "1-50",
        category: Categories.DATABASES,
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        length: "2-50",
        category: Categories.STORAGE,
        learnUrl: "https://docs.microsoft.com/en-us/azure/storsimple/storsimple-overview",
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/storsimple_device",
        restrictions: "Alphanumerics and hyphens. Start with letter. End with alphanumeric.",
      ...
      },
      {
        ...
        learnUrl: "https://docs.microsoft.com/en-us/azure/search/search-what-is-azure-search",
    ...
    items: [
      {
        ...
        learnUrl: "https://docs.microsoft.com/en-us/azure/analysis-services/analysis-services-overview",
      ...
      },
      {
        ...
        length: "3-64",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/databricks/scenarios/what-is-azure-databricks",
      ...
      },
      {
        ...
        length: "3-63",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/stream-analytics/stream-analytics-introduction",
      ...
      },
      {
        ...
        length: "4-22",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/data-explorer/data-explorer-overview",
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/data_explorer_cluster",
      ...
      },
      {
        ...
        length: "1-260",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/data-explorer/kusto/management/",
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/data_explorer_database",
      ...
      },
      {
        ...
        length: "3-63",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/data-factory/introduction",
      ...
      },
      {
        ...
        length: "6-50",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/event-hubs/event-hubs-about",
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        length: "3-59",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/hdinsight/hadoop/hadoop-overview",
      ...
      },
      {
        ...
        length: "3-59",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/hdinsight/hbase/hbase-overview",
      ...
      },
      {
        ...
        length: "3-59",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/hdinsight/kafka/apache-kafka-introduction",
      ...
      },
      {
        ...
        length: "3-59",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/hdinsight/spark/apache-spark-overview",
      ...
      },
      {
        ...
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/hdinsight_storm_cluster",
        restrictions: "Alphanumerics and hyphens. Start and end with letter or number.",
        resource: "Microsoft.HDInsight",
        entity: "clusters",
        scope: "global",
      ...
      },
      {
        ...
        length: "3-59",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/hdinsight/r-server/r-server-overview",
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/hdinsight_rserver_cluster",
        restrictions: "Alphanumerics and hyphens. Start and end with letter or number.",
        resource: "Microsoft.HDInsight",
        entity: "clusters",
        scope: "global",
    ...
    items: [
      {
        ...
        length: "3-64",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/iot-dps/about-iot-dps",
      ...
      },
      {
        ...
        length: "1-64",
        category: Categories.ANALYTICSANDIOT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/iot-dps/how-to-verify-certificates",
      ...
      },
      {
        ...
        learnUrl: "https://docs.microsoft.com/en-us/azure/virtual-desktop/host-pool",
      ...
      },
      {
        ...
        length: "1-64",
        category: Categories.VIRTUALDESKTOP,
        learnUrl: "https://docs.microsoft.com/en-us/azure/virtual-desktop/workspace",
      ...
      },
      {
        ...
        learnUrl: "https://docs.microsoft.com/en-us/azure/azure-app-configuration/overview",
      ...
      },
      {
        ...
        length: "3-63",
        category: Categories.DEVTOOLS,
        learnUrl: "https://docs.microsoft.com/en-us/azure/azure-signalr/signalr-overview",
  ...
  },
  {
    items: [
      ...
      },
      {
        ...
        length: "1-43",
        category: Categories.INTEGRATION,
        learnUrl: "https://docs.microsoft.com/en-us/azure/logic-apps/logic-apps-overview",
      ...
      },
      {
        ...
        length: "6-50",
        category: Categories.INTEGRATION,
        learnUrl: "https://docs.microsoft.com/en-us/azure/service-bus-messaging/service-bus-messaging-overview",
      ...
      },
      {
        ...
        length: "1-260",
        category: Categories.INTEGRATION,
        learnUrl: "https://docs.microsoft.com/en-us/azure/service-bus-messaging/service-bus-queues-topics-subscriptions",
      ...
      },
      {
        ...
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/migrate_project",
      ...
      },
      {
        ...
        terraformUrl: "https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/databox_edge_device",
        restrictions: "Alphanumerics, hyphens, periods, and underscores. Start with alphanumeric.",
        resource: "Microsoft.DataMigration",
        entity: "services",
        scope: "resource group",
    ...
    items: [
      {
        ...
        learnUrl: "https://docs.microsoft.com/en-us/azure/automation/automation-intro",
      ...
      },
      {
        ...
        length: "90",
        category: Categories.MANAGEMENT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/governance/blueprints/overview",
        terraformUrl: "",
        restrictions: "Alphanumerics, underscores, and hyphens.",
      ...
      },
      {
        ...
        length: "4-63",
        category: Categories.MANAGEMENT,
        learnUrl: "https://docs.microsoft.com/en-us/azure/azure-monitor/logs/design-workspace",
